            ...
            <div class="col-10 ">
              <div class=" container-fluid">
                ...
                <tr>
                    ...
                    <td>
                    <a href="batch_edit.php?bid=<?php echo $bid;?>"><button type="button" class=" btn btn-success">Edit</button></a>
                    <a href="batch_delete.php?bid=<?php echo $bid; ?>"><button type="button" class=" btn btn-danger">Delete</button></a>
                    </td>
                </tr>
                <?php
                }
