            ...
            <div class="col-10 ">
              <div class=" container-fluid">
                <div class="row">
                 ...
                 <div class="col-4">
                 <p>
        <form action="collection_entry.php" method="POST" class="bg-light p-2">
                  
        <div class="mb-3 mt-3">
                <label for="contactno" class="form-label">Select Student Name:</label>           
                ...
                <div class="mb-3 mt-3">
                    <label for="contactno" class="form-label">Collection Date</label>
                    <input type="date" class="form-control" id="colldate"  name="colldate">
                </div>
                <div class="mb-3 mt-3">
                    <label for="contactemail" class="form-label">Collection Amount</label>
                    <input type="number" class="form-control" id="collamount" placeholder="Enter collect amound" name="collamount">
                </div>
                <div class="mb-3 mt-3">
                    <label for="image" class="form-label">collect Note</label>
