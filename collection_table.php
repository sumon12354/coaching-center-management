            ...
            <div class="col-10 ">
              <div class=" container-fluid">
                ...
                <tr>
                    ...
                    <td>
                    <a href="collection_edit.php?sid=<?php echo $collid;?>"><button type="button" class=" btn btn-success">Edit</button></a>
                    <a href="collection_delete.php?sid=<?php echo $collid; ?>"><button type="button" class=" btn btn-danger">Delete</button></a>
                    </td>
                </tr>
                <?php
                }
